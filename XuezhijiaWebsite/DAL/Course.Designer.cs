...
namespace DAL {
    ...
    public partial class Course : global::System.Data.DataSet {
        ...
        public partial class CourseDataTable : global::System.Data.TypedTableBase<CourseRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public CourseRow AddCourseRow(long TID, string CourseName, int Lessons, string Location, string Time, int MaxNumber, int PID, string Comment) {
...
namespace DAL.CourseTableAdapters {
    ...
    public partial class CourseTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Course] ([TID], [CourseName], [Lessons], [Location], [Time], [MaxNumber], [PID], [Comment]) VALUES (@TID, @CourseName, @Lessons, @Location, @Time, @MaxNumber, @PID, @Comment);
SELECT CourseID, TID, CourseName, Lessons, Location, Time, MaxNumber, PID, Comment FROM Course WHERE (CourseID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Course] SET [TID] = @TID, [CourseName] = @CourseName, [Lessons] = @Lessons, [Location] = @Location, [Time] = @Time, [MaxNumber] = @MaxNumber, [PID] = @PID, [Comment] = @Comment WHERE (([CourseID] = @Original_CourseID) AND ((@IsNull_TID = 1 AND [TID] IS NULL) OR ([TID] = @Original_TID)) AND ((@IsNull_CourseName = 1 AND [CourseName] IS NULL) OR ([CourseName] = @Original_CourseName)) AND ((@IsNull_Lessons = 1 AND [Lessons] IS NULL) OR ([Lessons] = @Original_Lessons)) AND ((@IsNull_Location = 1 AND [Location] IS NULL) OR ([Location] = @Original_Location)) AND ((@IsNull_Time = 1 AND [Time] IS NULL) OR ([Time] = @Original_Time)) AND ((@IsNull_MaxNumber = 1 AND [MaxNumber] IS NULL) OR ([MaxNumber] = @Original_MaxNumber)) AND ((@IsNull_PID = 1 AND [PID] IS NULL) OR ([PID] = @Original_PID)));
SELECT CourseID, TID, CourseName, Lessons, Location, Time, MaxNumber, PID, Comment FROM Course WHERE (CourseID = @CourseID)";
        ...
        public virtual int Delete(long Original_CourseID, global::System.Nullable<long> Original_TID, string Original_CourseName, global::System.Nullable<int> Original_Lessons, string Original_Location, string Original_Time, global::System.Nullable<int> Original_MaxNumber, global::System.Nullable<int> Original_PID) {
        ...
        public virtual int Insert(global::System.Nullable<long> TID, string CourseName, global::System.Nullable<int> Lessons, string Location, string Time, global::System.Nullable<int> MaxNumber, global::System.Nullable<int> PID, string Comment) {
        ...
        public virtual int Update(
            ...
            this.Adapter.UpdateCommand.Parameters[8].Value = ((long)(Original_CourseID));
            if ((Original_TID.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[9].Value = ((object)(0));
                this.Adapter.UpdateCommand.Parameters[10].Value = ((long)(Original_TID.Value));
            }
            else {
            ...
            if ((Original_Lessons.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[14].Value = ((int)(Original_Lessons.Value));
            }
            else {
            ...
            if ((Original_MaxNumber.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[20].Value = ((int)(Original_MaxNumber.Value));
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[23].Value = ((long)(CourseID));
        ...
        public virtual int Update(
                    ...
                    global::System.Nullable<int> Original_MaxNumber, 
                    global::System.Nullable<int> Original_PID) {
            return this.Update(TID, CourseName, Lessons, Location, Time, MaxNumber, PID, Comment, Original_CourseID, Original_TID, Original_CourseName, Original_Lessons, Original_Location, Original_Time, Original_MaxNumber, Original_PID, Original_CourseID);
        }
    }
