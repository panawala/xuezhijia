...
namespace DAL {
    ...
    public partial class Commodity : global::System.Data.DataSet {
        ...
        public partial class CommodityDataTable : global::System.Data.TypedTableBase<CommodityRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public CommodityRow AddCommodityRow(string ComName, string Type, double Price, string Detail, string Comment) {
...
namespace DAL.CommodityTableAdapters {
    ...
    public partial class CommodityTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Commodity] ([ComName], [Type], [Price], [Detail], [Comment]) V" +
                "ALUES (@ComName, @Type, @Price, @Detail, @Comment);\r\nSELECT ComID, ComName, Type" +
                ", Price, Detail, Comment FROM Commodity WHERE (ComID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Commodity] SET [ComName] = @ComName, [Type] = @Type, [Price] = @Price, [Detail] = @Detail, [Comment] = @Comment WHERE (([ComID] = @Original_ComID) AND ((@IsNull_ComName = 1 AND [ComName] IS NULL) OR ([ComName] = @Original_ComName)) AND ((@IsNull_Type = 1 AND [Type] IS NULL) OR ([Type] = @Original_Type)) AND ((@IsNull_Price = 1 AND [Price] IS NULL) OR ([Price] = @Original_Price)) AND ((@IsNull_Detail = 1 AND [Detail] IS NULL) OR ([Detail] = @Original_Detail)) AND ((@IsNull_Comment = 1 AND [Comment] IS NULL) OR ([Comment] = @Original_Comment)));
SELECT ComID, ComName, Type, Price, Detail, Comment FROM Commodity WHERE (ComID = @ComID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ComID, ComName, Type, Price, Detail, Comment FROM dbo.Commodity";
        ...
        public virtual int Delete(long Original_ComID, string Original_ComName, string Original_Type, global::System.Nullable<double> Original_Price, string Original_Detail, string Original_Comment) {
        ...
        public virtual int Insert(string ComName, string Type, global::System.Nullable<double> Price, string Detail, string Comment) {
            if ((ComName == null)) {
        ...
        public virtual int Update(string ComName, string Type, global::System.Nullable<double> Price, string Detail, string Comment, long Original_ComID, string Original_ComName, string Original_Type, global::System.Nullable<double> Original_Price, string Original_Detail, string Original_Comment, long ComID) {
            if ((ComName == null)) {
            ...
            this.Adapter.UpdateCommand.Parameters[5].Value = ((long)(Original_ComID));
            if ((Original_ComName == null)) {
            ...
            if ((Original_Detail == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[13].Value = ((string)(Original_Detail));
            }
            if ((Original_Comment == null)) {
            ...
            this.Adapter.UpdateCommand.Parameters[16].Value = ((long)(ComID));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string ComName, string Type, global::System.Nullable<double> Price, string Detail, string Comment, long Original_ComID, string Original_ComName, string Original_Type, global::System.Nullable<double> Original_Price, string Original_Detail, string Original_Comment) {
            return this.Update(ComName, Type, Price, Detail, Comment, Original_ComID, Original_ComName, Original_Type, Original_Price, Original_Detail, Original_Comment, Original_ComID);
        }
    }
