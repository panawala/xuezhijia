...
namespace DAL {
    ...
    public partial class FileRecords : global::System.Data.DataSet {
        ...
        public partial class FileRecordsDataTable : global::System.Data.TypedTableBase<FileRecordsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public FileRecordsRow AddFileRecordsRow(long UserID, string Size, string FileName, int PageCount, string DateTime, string State, string Comment) {
...
namespace DAL.FileRecordsTableAdapters {
    ...
    public partial class FileRecordsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[FileRecords] ([UserID], [Size], [FileName], [PageCount], [DateTime], [State], [Comment]) VALUES (@UserID, @Size, @FileName, @PageCount, @DateTime, @State, @Comment);
SELECT RecordID, UserID, Size, FileName, PageCount, DateTime, State, Comment FROM FileRecords WHERE (RecordID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[FileRecords] SET [UserID] = @UserID, [Size] = @Size, [FileName] = @FileName, [PageCount] = @PageCount, [DateTime] = @DateTime, [State] = @State, [Comment] = @Comment WHERE (([RecordID] = @Original_RecordID) AND ([UserID] = @Original_UserID) AND ((@IsNull_Size = 1 AND [Size] IS NULL) OR ([Size] = @Original_Size)) AND ((@IsNull_FileName = 1 AND [FileName] IS NULL) OR ([FileName] = @Original_FileName)) AND ((@IsNull_PageCount = 1 AND [PageCount] IS NULL) OR ([PageCount] = @Original_PageCount)) AND ((@IsNull_DateTime = 1 AND [DateTime] IS NULL) OR ([DateTime] = @Original_DateTime)) AND ((@IsNull_State = 1 AND [State] IS NULL) OR ([State] = @Original_State)) AND ((@IsNull_Comment = 1 AND [Comment] IS NULL) OR ([Comment] = @Original_Comment)));
SELECT RecordID, UserID, Size, FileName, PageCount, DateTime, State, Comment FROM FileRecords WHERE (RecordID = @RecordID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT RecordID, UserID, Size, FileName, PageCount, DateTime, State, Comment FROM" +
                " dbo.FileRecords";
        ...
        public virtual int Delete(long Original_RecordID, long Original_UserID, string Original_Size, string Original_FileName, global::System.Nullable<int> Original_PageCount, string Original_DateTime, string Original_State, string Original_Comment) {
            ...
            if ((Original_DateTime == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[9].Value = ((string)(Original_DateTime));
            }
        ...
        public virtual int Insert(long UserID, string Size, string FileName, global::System.Nullable<int> PageCount, string DateTime, string State, string Comment) {
        ...
        public virtual int Update(
            ...
            this.Adapter.UpdateCommand.Parameters[7].Value = ((long)(Original_RecordID));
            ...
            if ((Original_PageCount.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[14].Value = ((int)(Original_PageCount.Value));
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[21].Value = ((long)(RecordID));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(long UserID, string Size, string FileName, global::System.Nullable<int> PageCount, string DateTime, string State, string Comment, long Original_RecordID, long Original_UserID, string Original_Size, string Original_FileName, global::System.Nullable<int> Original_PageCount, string Original_DateTime, string Original_State, string Original_Comment) {
            return this.Update(UserID, Size, FileName, PageCount, DateTime, State, Comment, Original_RecordID, Original_UserID, Original_Size, Original_FileName, Original_PageCount, Original_DateTime, Original_State, Original_Comment, Original_RecordID);
        }
    }
