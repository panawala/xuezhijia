<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CarManage.aspx.cs" Inherits="XuezhijiaWebsite.CarManage" %>
...
&nbsp;<asp:GridView ID="Cars" runat="server" AutoGenerateColumns="False" DataKeyNames="CarID" OnRowDeleting="RowDeleting" OnRowCommand="RowUpdate">
      <Columns>
            ...
            <ItemTemplate>   
                <asp:LinkButton ID="LinkButton1" CommandName="Delete" runat="server" CausesValidation="False" CommandArgument='<%# Eval("CarID") %>'
