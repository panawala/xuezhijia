...
namespace DAL {
    ...
    public partial class Hotel : global::System.Data.DataSet {
        ...
        public partial class HotelDataTable : global::System.Data.TypedTableBase<HotelRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public HotelRow AddHotelRow(string HotelName, string Location, string ContactWay, string Type, string Price, string PIDList, string Comment, int PID) {
...
namespace DAL.HotelTableAdapters {
    ...
    public partial class HotelTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Hotel] ([HotelName], [Location], [ContactWay], [Type], [Price], [PIDList], [Comment], [PID]) VALUES (@HotelName, @Location, @ContactWay, @Type, @Price, @PIDList, @Comment, @PID);
SELECT HotelID, HotelName, Location, ContactWay, Type, Price, PIDList, Comment, PID FROM Hotel WHERE (HotelID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Hotel] SET [HotelName] = @HotelName, [Location] = @Location, [ContactWay] = @ContactWay, [Type] = @Type, [Price] = @Price, [PIDList] = @PIDList, [Comment] = @Comment, [PID] = @PID WHERE (([HotelID] = @Original_HotelID) AND ((@IsNull_HotelName = 1 AND [HotelName] IS NULL) OR ([HotelName] = @Original_HotelName)) AND ((@IsNull_Location = 1 AND [Location] IS NULL) OR ([Location] = @Original_Location)) AND ((@IsNull_ContactWay = 1 AND [ContactWay] IS NULL) OR ([ContactWay] = @Original_ContactWay)) AND ((@IsNull_Type = 1 AND [Type] IS NULL) OR ([Type] = @Original_Type)) AND ((@IsNull_Price = 1 AND [Price] IS NULL) OR ([Price] = @Original_Price)) AND ((@IsNull_Comment = 1 AND [Comment] IS NULL) OR ([Comment] = @Original_Comment)) AND ((@IsNull_PID = 1 AND [PID] IS NULL) OR ([PID] = @Original_PID)));
SELECT HotelID, HotelName, Location, ContactWay, Type, Price, PIDList, Comment, PID FROM Hotel WHERE (HotelID = @HotelID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT HotelID, HotelName, Location, ContactWay, Type, Price, PIDList, Comment, P" +
                "ID FROM dbo.Hotel";
        ...
        public virtual int Delete(long Original_HotelID, string Original_HotelName, string Original_Location, string Original_ContactWay, string Original_Type, string Original_Price, string Original_Comment, global::System.Nullable<int> Original_PID) {
        ...
        public virtual int Insert(string HotelName, string Location, string ContactWay, string Type, string Price, string PIDList, string Comment, global::System.Nullable<int> PID) {
            if ((HotelName == null)) {
        ...
        public virtual int Update(
            ...
            this.Adapter.UpdateCommand.Parameters[8].Value = ((long)(Original_HotelID));
            if ((Original_HotelName == null)) {
            ...
            if ((Original_ContactWay == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[14].Value = ((string)(Original_ContactWay));
            }
            if ((Original_Type == null)) {
            ...
            this.Adapter.UpdateCommand.Parameters[23].Value = ((long)(HotelID));
        ...
        public virtual int Update(
                    ...
                    string Original_Comment, 
                    global::System.Nullable<int> Original_PID) {
            return this.Update(HotelName, Location, ContactWay, Type, Price, PIDList, Comment, PID, Original_HotelID, Original_HotelName, Original_Location, Original_ContactWay, Original_Type, Original_Price, Original_Comment, Original_PID, Original_HotelID);
        }
    }
