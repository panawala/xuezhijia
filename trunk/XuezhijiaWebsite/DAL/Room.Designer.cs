...
namespace DAL {
    ...
    public partial class Room : global::System.Data.DataSet {
        ...
        public partial class RoomDataTable : global::System.Data.TypedTableBase<RoomRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public RoomRow AddRoomRow(byte[] Location, double Price, byte[] Type, byte[] DistanceFromTongji, byte[] LinkURL, string Comment) {
        ...
        public partial class RoomRow : global::System.Data.DataRow {
            ...
            public byte[] Location {
                get {
                    try {
                        return ((byte[])(this[this.tableRoom.LocationColumn]));
                    }
            ...
            public byte[] LinkURL {
                get {
                    try {
                        return ((byte[])(this[this.tableRoom.LinkURLColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
...
SELECT RoomID, Location, Price, Type, DistanceFromTongji, LinkURL, Comment FROM Room WHERE (RoomID = @RoomID)";
        ...
        public virtual int Delete(long Original_RoomID, byte[] Original_Location, global::System.Nullable<double> Original_Price, byte[] Original_Type, byte[] Original_DistanceFromTongji, byte[] Original_LinkURL, string Original_Comment) {
            ...
            if ((Original_Location == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[2].Value = ((byte[])(Original_Location));
            }
        ...
        public virtual int Insert(byte[] Location, global::System.Nullable<double> Price, byte[] Type, byte[] DistanceFromTongji, byte[] LinkURL, string Comment) {
            if ((Location == null)) {
        ...
        public virtual int Update(byte[] Location, global::System.Nullable<double> Price, byte[] Type, byte[] DistanceFromTongji, byte[] LinkURL, string Comment, long Original_RoomID, byte[] Original_Location, global::System.Nullable<double> Original_Price, byte[] Original_Type, byte[] Original_DistanceFromTongji, byte[] Original_LinkURL, string Original_Comment, long RoomID) {
            if ((Location == null)) {
            ...
            if ((Original_Location == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[8].Value = ((byte[])(Original_Location));
            }
            if ((Original_Price.HasValue == true)) {
            ...
            if ((Original_LinkURL == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[16].Value = ((byte[])(Original_LinkURL));
            }
            if ((Original_Comment == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(byte[] Location, global::System.Nullable<double> Price, byte[] Type, byte[] DistanceFromTongji, byte[] LinkURL, string Comment, long Original_RoomID, byte[] Original_Location, global::System.Nullable<double> Original_Price, byte[] Original_Type, byte[] Original_DistanceFromTongji, byte[] Original_LinkURL, string Original_Comment) {
